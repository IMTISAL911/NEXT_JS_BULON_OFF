...
//                 <button onClick={() => dispatch(increment())} className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition">
//                     INCREMENT
//                 </button>
//                 <button onClick={() => dispatch(decrement())} className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition">
//                     DECREMENT
//                 </button>
//             </div>
//         </div>
...
export default function Counter() {
    const dispatch = useDispatch();
    const counter = useSelector((state) => state.counter.counter); // get counter value from Redux
